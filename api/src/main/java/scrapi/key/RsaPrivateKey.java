...
public interface RsaPrivateKey extends PrivateKey<java.security.PrivateKey, RsaPublicKey>, RsaKey<java.security.PrivateKey> {
    ...
    /**
     * Returns the private exponent, a positive integer, if it is available. The value may not be
     ...
     *
     * @return the private exponent, a positive integer, if it is available.
