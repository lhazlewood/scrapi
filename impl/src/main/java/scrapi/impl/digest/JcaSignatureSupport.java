...
abstract class JcaSignatureSupport<T extends DataConsumer<T>, K extends AsymmetricKey<?>> extends AbstractDataConsumer<T> {
    ...
    private void apply(CheckedRunnable r) {
        try {
            ...
            throw new DigestException(msg, t);
        }
    }
    ...
    static class JcaSigner extends JcaSignatureSupport<JcaSigner, PrivateKey<?, ?>> implements Digester<JcaSigner> {
        ...
        public byte[] get() {
            try {
                ...
                throw new DigestException(msg, e);
            }
        }
    }
